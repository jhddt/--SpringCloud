  ...
  <el-container class="layout-container">
    <el-aside width="260px" class="sidebar">
      <div class="logo-container">
        ...
        <div class="logo-text">
          <div class="logo-title">教务管理</div>
          <div class="logo-subtitle">Education System</div>
        </div>
      </div>
      <el-menu
      ...
      >
        ...
        <el-menu-item index="/teachers" class="menu-item">
        ...
        <el-menu-item index="/selections" class="menu-item">
...
import { House, User, Avatar, Document, List, Message, Setting, UserFilled, SwitchButton, ArrowDown } from '@element-plus/icons-vue'
