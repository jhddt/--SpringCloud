  ...
  <el-container class="layout-container">
    <el-aside width="260px" class="sidebar">
      ...
      >
        ...
        <el-menu-item index="/my-course" class="menu-item">
          <el-icon><Document /></el-icon>
          <span>我的课程</span>
        </el-menu-item>
        <el-menu-item index="/selection-management" class="menu-item">
...
import { House, Document, List, Trophy, Message, User, Avatar, UserFilled, SwitchButton, ArrowDown } from '@element-plus/icons-vue'
...
onMounted(async () => {
  // 如果用户已登录但没有头像，尝试加载
  if (userStore.token && userStore.role === 'TEACHER' && !userStore.avatar) {
    await userStore.loadTeacherInfo()
  }
})
